...
public class Dijkstra {
    private final ArrayList<String> nodeNames;
    ...
    public void LoadWeightsFromDatabase(IDatabaseService IDatabaseService) {
        List<int[]> weightsFromDb = IDatabaseService.GetWeights();
