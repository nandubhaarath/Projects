...
public class VolunteerAssignmentConsoleApp {
    public static void main(String[] args) {
        ...
        VolunteerDeliveryAssignmentService assignmentService = new VolunteerDeliveryAssignmentService(databaseService);
        ...
        try {
            ...
            while (true) {
                ...
                if (choice == 1) {
                    ...
                    // Update the status
                    assignmentService.updateAssignmentStatus(assignmentId, statusId);
