...
public class RouteMapConsoleAppv1
{
    public static void main(String[] args) {
        ...
        try {
            ...
            if (choice == 1) {
                // Visit all nodes using the original logic
                System.out.println("\nGenerating route to visit all nodes...");
                route = routeMapVisitAllNodes.GenerateRouteMap(startAddress, endAddress, filteredRequests, weightsFromDb);
